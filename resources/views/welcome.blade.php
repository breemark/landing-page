<x-landing-layout>
        ...
        <div class="flex container mx-auto items-center h-full">
            <div class="flex w-1/3 flex-col items-start">
                ...
                <p class="text-indigo-200 text-xl mb-10">
                    Lorem ipsum dolor sit amet <span class="font-bold underline">Torres</span> consectetur adipisicing elit. Beatae eius.
                </p>
    ...
    <div class="flex flex-col bg-pink-500 h-screen">
        <p class="text-white font-extrabold text-5xl text-center w-full pt-5">Let's do it.</p>
        ...
        <form class="flex flex-col items-center p-24">
            ...
            <x-button class="px-5 py-3 mt-5 w-80 bg-blue-500 justify-center">Submit</x-button>
        </form>
    </div>
</x-landing-layout>